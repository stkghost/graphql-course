        ...
        this.handleRequest = async (request, ...args) => {
            ...
            try {
                ...
                if (requestUrl.pathname.endsWith('/readiness')) {
                    const readinessResponse = await crossUndiciFetch.fetch(request.url.replace('/readiness', '/health'));
                ...
                if (shouldRenderGraphiQL(request)) {
                    ...
                    if (graphiqlOptions) {
                        const graphiQLBody = renderGraphiql.renderGraphiQL(graphiqlOptions);
...
Object.defineProperty(exports, 'renderGraphiQL', {
    enumerable: true,
    get: function () {
        return renderGraphiql.renderGraphiQL;
    }
});
