import type { DocumentNode, ExecutionResult, GraphQLError, GraphQLSchema, OperationDefinitionNode } from 'graphql';
...
export interface RequestProcessContext<TContext, TRootValue> extends YogaInitialContext {
    /**
