...
import { Request, Blob, FormData } from 'cross-undici-fetch';
...
function getNodeRequest(nodeRequest, defaultAddressInfo) {
    var _a;
...
class YogaNodeServer extends YogaServer {
    constructor(options) {
        ...
        this.addressInfo = {
            ...
            hostname: (options === null || options === void 0 ? void 0 : options.hostname) || (platform() === 'win32' ? '127.0.0.1' : '0.0.0.0'),
